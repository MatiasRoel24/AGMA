            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start lg:justify-between">
                <div className="h-auto w-auto">
                  <span className='text-white font-bold'>SDS - <span className='color-primary'>Skyward Digital Solutions</span></span>
                </div>
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          'rounded-md px-3 py-2 text-sm font-medium hover:bg-cyan-900 text-white'
                        )}
